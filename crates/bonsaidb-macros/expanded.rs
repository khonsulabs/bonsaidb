...
fn tuple_struct() {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::Key<'__bonsaidb_macros_key> for Test {
        ...
        fn into_owned(self) -> Self::Owned {
            Test(
                ::bonsaidb::core::key::Key::into_owned(self.0),
                ::bonsaidb::core::key::Key::into_owned(self.1),
                ::bonsaidb::core::key::Key::into_owned(self.2),
            )
        }
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test {
...
fn transparent_structs() {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::Key<'__bonsaidb_macros_key> for Test {
        ...
        type Owned = Test;
        fn into_owned(self) -> Self::Owned {
            Test(::bonsaidb::core::key::Key::into_owned(self.0))
        }
        fn from_ord_bytes<'__bonsaidb_macros_b>(
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test {
        type Error = <i32 as ::bonsaidb::core::key::KeyEncoding>::Error;
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::Key<'__bonsaidb_macros_key> for TestNamed {
        ...
        fn into_owned(self) -> Self::Owned {
            TestNamed {
                named: ::bonsaidb::core::key::Key::into_owned(self.named),
            }
        }
        fn from_ord_bytes<'__bonsaidb_macros_b>(
            bytes: ::bonsaidb::core::key::ByteSource<'__bonsaidb_macros_key, '__bonsaidb_macros_b>,
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for TestNamed {
        type Error = <i32 as ::bonsaidb::core::key::KeyEncoding>::Error;
        const LENGTH: ::core::prelude::v1::Option<usize> = <i32>::LENGTH;
        fn describe<Visitor>(visitor: &mut Visitor)
        where
...
fn struct_struct() {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::Key<'__bonsaidb_macros_key> for Test {
        ...
        fn into_owned(self) -> Self::Owned {
            Self {
                a: ::bonsaidb::core::key::Key::into_owned(self.a),
                b: ::bonsaidb::core::key::Key::into_owned(self.b),
            }
        }
        fn from_ord_bytes<'__bonsaidb_macros_b>(
            mut __bonsaidb_macros_bytes: ::bonsaidb::core::key::ByteSource<
        ...
        fn into_owned(self) -> Self::Owned {
            match self {
                ...
                Self::B(__bonsaidb_macros_field_0, __bonsaidb_macros_field_1) => Test::B(
                    ::bonsaidb::core::key::Key::into_owned(__bonsaidb_macros_field_0),
                    ::bonsaidb::core::key::Key::into_owned(__bonsaidb_macros_field_1),
                ),
                Self::C { a, b } => Test::C {
                    a: ::bonsaidb::core::key::Key::into_owned(a),
                    b: ::bonsaidb::core::key::Key::into_owned(b),
                },
            }
        }
        fn from_ord_bytes<'__bonsaidb_macros_b>(
...
fn enum_repr() {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test1 {
        type Error = ::bonsaidb::core::key::CompositeKeyError;
        const LENGTH: ::core::prelude::v1::Option<usize> =
            <u8 as ::bonsaidb::core::key::KeyEncoding>::LENGTH;
        fn describe<Visitor>(visitor: &mut Visitor)
        where
            Visitor: ::bonsaidb::core::key::KeyVisitor,
        {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test2 {
        type Error = ::bonsaidb::core::key::CompositeKeyError;
        const LENGTH: ::core::prelude::v1::Option<usize> =
            <u8 as ::bonsaidb::core::key::KeyEncoding>::LENGTH;
        fn describe<Visitor>(visitor: &mut Visitor)
...
fn enum_u64() {
    ...
    impl<'__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test {
        type Error = ::bonsaidb::core::key::CompositeKeyError;
        const LENGTH: ::core::prelude::v1::Option<usize> =
            <u64 as ::bonsaidb::core::key::KeyEncoding>::LENGTH;
        fn describe<Visitor>(visitor: &mut Visitor)
        where
            Visitor: ::bonsaidb::core::key::KeyVisitor,
        {
...
fn lifetime() {
    ...
    impl<'a, 'b, '__bonsaidb_macros_key> ::bonsaidb::core::key::KeyEncoding<Self> for Test<'a, 'b>
    where
        '__bonsaidb_macros_key: 'a,
        '__bonsaidb_macros_key: 'b,
    {
