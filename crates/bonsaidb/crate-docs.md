...
[![Live Build Status](https://img.shields.io/github/workflow/status/khonsulabs/bonsaidb/Tests/v0.1.2)](https://github.com/khonsulabs/bonsaidb/actions?query=workflow:Tests)
[![HTML Coverage Report for `v0.1.2`](https://dev.bonsaidb.io/v0.1.2/coverage/badge.svg)](https://dev.bonsaidb.io/v0.1.2/coverage/)
[![Documentation for `v0.1.2`](https://img.shields.io/badge/docs-v0.1.2-informational)](https://docs.rs/bonsaidb)
...
[collection]: https://dev.bonsaidb.io/v0.1.2/guide/about/concepts/collection.html
[key-value]: https://dev.bonsaidb.io/v0.1.2/guide/traits/key-value.html
...
[view-examples]: https://github.com/khonsulabs/bonsaidb/blob/v0.1.2/examples/basic-local/examples/view-examples.rs
[examples-readme]: https://github.com/khonsulabs/bonsaidb/blob/v0.1.2/examples/README.md
