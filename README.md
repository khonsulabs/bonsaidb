...
[![Live Build Status](https://img.shields.io/github/workflow/status/khonsulabs/bonsaidb/Tests/v0.1.1)](https://github.com/khonsulabs/bonsaidb/actions?query=workflow:Tests)
[![HTML Coverage Report for `v0.1.1`](https://dev.bonsaidb.io/v0.1.1/coverage/badge.svg)](https://dev.bonsaidb.io/v0.1.1/coverage/)
[![Documentation for `v0.1.1`](https://img.shields.io/badge/docs-v0.1.1-informational)](https://docs.rs/bonsaidb)
...
[collection]: https://dev.bonsaidb.io/v0.1.1/guide/about/concepts/collection.html
[key-value]: https://dev.bonsaidb.io/v0.1.1/guide/traits/key-value.html
...
[view-examples]: https://github.com/khonsulabs/bonsaidb/blob/v0.1.1/examples/basic-local/examples/view-examples.rs
[examples-readme]: https://github.com/khonsulabs/bonsaidb/blob/v0.1.1/examples/README.md
